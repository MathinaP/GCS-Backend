...
<style>
  /*
   * @page margin-top (26mm) = exact height of #hdr
   * @page margin-bottom (15mm) = exact height of #ftr
   * Fixed elements use negative offsets to reach into the margin area,
   * so they sit above/below the content area and never overlap it.
   */
  @page { margin: 26mm 8mm 15mm 8mm; size: A4 portrait; }
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .co-info { font-size: 6.8pt; color: #333; line-height: 1.5; margin-top: 2pt; }

  /* ── Footer: sits in the bottom margin area ── */
  #ftr {
    position: fixed;
    bottom: -15mm;
    left: -8mm; right: -8mm;
...
{{-- ══ HEADER (in top margin, does not affect content flow) ══ --}}
<div id="hdr">
  <table>
    <tr>
      <td style="width:60pt; text-align:center; padding-right:5pt;">
      ...
      <td style="width:84pt; text-align:right;">
...
{{-- ══ FOOTER (in bottom margin, does not affect content flow) ══ --}}
<div id="ftr">
...
{{-- ══ CONTENT (starts at top of content area, safely below header) ══ --}}
